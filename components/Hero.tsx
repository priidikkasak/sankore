...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: '#080808' }}>
      <div className="max-w-7xl mx-auto px-8 md:px-12 w-full pt-36 md:pt-28 pb-20 grid md:grid-cols-[58fr_42fr] gap-12 md:gap-16 items-center">
        ...
        <div>
          ...
          >
            ...
            <span
              className="italic"
              style={{ color: '#C9A84C', fontSize: '0.72em', display: 'block', marginTop: '0.15em', letterSpacing: '-0.01em' }}
            >
